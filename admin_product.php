<?php 
	...
	if (isset($_POST['add_product'])) {
		...
		if(mysqli_num_rows($select_product_name) > 0){
			$message[] = 'product nam already exist';
		}else{
	...
	<section class="show-products">
		<div class="box-container">
			...
			<div class="box">
				...
				<a href="admin_product.php?delete=<?php echo $fetch_products['id'] ?>" class="delete" onclick = "return conform('delete this product');">delete</a>
			</div>
			<?php 
					}
				}
